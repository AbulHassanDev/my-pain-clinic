...
import IconDropdown from "../../assets/images/career/dropdownIcon.svg";
  ...
  return (
    <div>
      <div className="">
        <motion.div
          {...yAxisAnimation}
          className=" flex items-center flex-col py-[4rem]  "
        >
        ...
        <div className="bg-[#D6E8D4]   md:py-14 py-6">
          <form className="max-w-7xl w-[90%] mx-auto">
            ...
            <div className="flex justify-center items-center">
              <button
                type="submit"
                className="bg-gradient-to-r from-[#036DED]  to-[#5BD6DD] text-white rounded-full py-2 px-12 hover:from-white hover:to-white hover:text-sky transition-all delay-150 ease-linear"
              >
                Submit
              </button>
            </div>
